...
def build_config(
    ...
    return {
        ...
        "paths": {
            ...
            "decisions_path": ".stangent/decisions.json",
            "registry_path":  ".stangent/features_registry.json",
            "symbol_index":   ".stangent/symbol_index.json",
        ...
        "models": {
            ...
            "planner_direct":     fast,
            "implementer":        strong,
            "implementer_direct": fast,
            "reviewer":           strong,
            "reviewer_direct":    fast,
