...
- Templates are **system-owned**: the installer mirror-replaces this directory on every install. Don't edit a template in an installed project and expect it to survive a re-install — edit the source in `stangent-v3/.claude/templates/` instead.
